  ...
  return (
    ...
    >
      ...
      <div className="!w-full !max-w-12xl !mx-auto !min-h-full flex flex-col md:flex-row items-center justify-center md:!gap-8 relative z-10">
        ...
        <div className="flex flex-col relative w-full md:w-1/2 z-10 px-6 md:px-4 md:pl-0 pb-20 md:pb-0 !text-[var(--color-primary)] justify-center">
          ...
          <h2 className="!font-lust text-[2.5rem] md:text-[6rem] lg:text-[4.5rem] leading-none !text-[var(--color-primary)] !ml-[30px] !mt-[15px] md:mt-[5px]">
            {secondPart}
          </h2>          
          
          <p className="font-area-regular text-[15px] md:text-[17px] !text-[var(--color-primary)] max-w-sm leading-relaxed !mt-4 md:!mt-8 !ml-4 md:!ml-7">
            {displayRoom.description}
          </p>

          {/* --- AMENITIES: Occupancy and Bed Type --- */}
          <div className="font-area-regular flex items-center gap-10 !mt-4 !mb-4 !ml-7 !text-[var(--color-primary)]/80 text-[15px] md:text-[16px]">
          ...
          <button className="font-area-semibold bg-[#00000000] border-2 !text-[var(--color-primary)] rounded-full uppercase w-fit !px-12 !py-5 mx-auto md:mx-0 !ml-20 md:!ml-7 text-[12px] tracking-[0.1em] mt-10 shadow-lg transition-transform hover:scale-105 active:scale-95">
            Book Now
          </button>
        </div>
      </div>
